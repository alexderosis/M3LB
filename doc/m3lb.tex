...
\item \textbf{D3Q27 only}, no TRT or raw MRT, no regularised walls, no
...
\item \textbf{The CUDA implementation of \S\ref{sec:cuda} covers a fraction of
  ...
  physical magnetic wall, so every MHD case there is periodic; no TRT, raw
...
\item \textbf{The multiphase central-moment operator requires a product
  ...
  says so: D2Q9 or D3Q27. Both three-dimensional lattices in this tree satisfy
  it, so the restriction bites only if a non-product lattice is added --- which
  D3Q19 was, until it was removed on 2026-09-18.
